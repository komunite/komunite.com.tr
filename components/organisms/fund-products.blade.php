<div className="flex flex-col items-center gap-y-5 md:gap-y-7.5 lg:gap-y-10">
        ...
        <div title="Startup Recipes" target="_blank">
            <figure className="text-center flex flex-col items-center gap-y-3 md:gap-y-5 py-4 sm:py-6">
                <a href="https://productrecipes.com" title="Startup Recipes" target="_blank">
                    <img src="{{asset('img/product-recipes.svg')}}" className="h-8 sm:h-11" />
                </a>
                <figcaption>
        ...
        <div>
            <figure className="text-center flex flex-col items-center gap-y-3 md:gap-y-5 py-4 sm:py-6">
                <a href="https://notionbrandingkit.com" title="Branding Kit" target="_blank">
                    <x-svgs.branding-kit className="h-5 sm:h-8" />
                </a>
                <figcaption>
    ...
    <x-atoms.button href="{{$buttonLink}}" title="{{$buttonTitle}}" className="font-bold text-xl md:text-2xl xl:text-3xl py-3.5 px-7.5 lg:py-5 lg:px-10" />
</div>
