            ...
            <div className="space-y-5 lg:space-y-7.5">
                ...
                <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex items-center gap-x-2">
                        <x-atoms.lead-regular content="Yer:" className="font-bold" />
                ...
                <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex items-center gap-x-2">
                        <x-atoms.lead-regular content="Başlangıç:" className="font-bold" />
                ...
                <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex items-center gap-x-2">
                        <x-atoms.lead-regular content="Bitiş:" className="font-bold" />
                ...
                <div className="flex items-center gap-x-3">
                    <figure>
                        <x-svgs.focus className="h-7 md:h-9" />
                    </figure>
                    <div className="flex items-center gap-x-2">
                        <x-atoms.lead-regular content="Ödül Havuzu:" className="font-bold" />
                        <time className="text-lg md:text-xxl xl:text-2.25xl xl:leading-snug">2.500$</time>
                    </div>
                </div>
                {{-- <x-atoms.button href="#" title="Hackathon'a başvurun" className="font-bold text-xl md:text-2xl xl:text-3xl py-3.5 px-7.5 lg:py-5 lg:px-10" /> --}}
            </div>
            ...
            <div className="space-y-5 md:space-y-7.5 lg:space-y-10">
                ...
                <div className="grid md:grid-cols-3 items-center gap-7.5 md:gap-10">
                    ...
                    <figure className="justify-self-start md:justify-self-center">
                        <x-svgs.mukellef className="h-8 md:h-10 lg:h-15 w-full" />
                    </figure>
                    <figure className="justify-self-start md:justify-self-end">
                        <x-svgs.creatorstation className="h-6 md:h-8 lg:h-10 w-full" />
                    </figure>
                </div>
            </div>
            <div className="space-y-5 md:space-y-7.5 lg:space-y-10">
                ...
                <div className="grid md:grid-cols-3 items-center gap-7.5 md:gap-10">
                    <figure className="justify-self-start">
                        <x-svgs.swipeline className="h-7 md:h-9 lg:h-13 w-full" />
                    </figure>
                    <figure className="justify-self-start md:justify-self-center">
    ...
    <section className="mb-10 md:mb-15 lg:mb-20">
        <ContainerAtom className="grid gap-y-7.5 md:gap-y-10 lg:gap-y-0 lg:grid-cols-[auto_41.875rem] lg:gap-x-25">
            ...
            <div className="space-y-5 md:space-y-7.5 lg:space-y-10">
                ...
                {{-- <x-atoms.button href="#" title="Hackathon'a başvurun" className="font-bold md:text-xl lg:text-1xl py-3 px-6 md:py-3.5 md:px-7" /> --}}
            </div>
        </ContainerAtom>
    </section>
    <section className="mb-10 md:mb-15 lg:mb-20">
