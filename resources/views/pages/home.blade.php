<x-templates.base title="Anasayfa">
    ...
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container>
            <div class="bg-ghost space-y-5 lg:space-y-7.5 py-5 md:py-7.5 lg:py-10 px-7.5 md:px-10 lg:px-15 rounded-lg">
                <x-atoms.title-h2 title="Komünite nedir?" />
                <ul class="list-disc text-lg md:text-xxl xl:text-2.25xl xl:leading-tight space-y-2 ml-4 md:ml-7">
                    <li>
    ...
    <section class="mb-7.5 lg:mb-10">
        <x-atoms.container>
            <figure class="flex justify-center ">
                <img loading="lazy" src="img/screenshot.png" alt="Komünite" class="rounded-lg">
            </figure>
        </x-atoms.container>
    </section>
    ...
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container>
            <div class="bg-neptune text-bright space-y-7.5 lg:space-y-10 py-5 md:py-7.5 lg:py-10 px-7.5 md:px-10 lg:px-15 rounded-lg">
                <x-atoms.title-h3 title="Meraklı insanlar topluluğuna katılın ve ürün geliştirme serüvenine hemen başlayın." />
                ...
                <div class="grid gap-y-5 lg:gap-y-0 lg:grid-cols-2 lg:gap-x-7.5">
                    <div class="space-y-2 lg:space-y-3">
                        <x-atoms.body-bold content="Uzmanlardan Öğrenin:" />
                        <x-atoms.body-note content="Ürün geliştirme, tasarım, kodlama ve pazarlama gibi konularda uzmanlara ulaşmak her zaman kolay değil. Toplulukta yer alan uzman yaratıcılar, düzenli ve sürekli olarak katılımcıların sorularını cevaplıyor." />
                    </div>
                    <div class="space-y-2 lg:space-y-3">
                        <x-atoms.body-bold content="Etkinliklere Katılın:" />
                        <x-atoms.body-note content="Sizinle benzer yeteneklere sahip olan diğer profesyonellerle, özel temalar etrafında workshoplar, soru-cevap etkinlikleri ve sunumlar, topluluğun sunduğu fırsatlardan biri." />
                    </div>
                </div>
            </div>
        </x-atoms.container>
    ...
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container class="grid gap-y-7.5 md:gap-y-0 md:grid-cols-2 md:gap-x-5 lg:gap-x-7.5">
            <div class="bg-bubble-gum space-y-9 lg:space-y-13 py-5 px-7.5 lg:py-7.5 lg:px-10 rounded-lg">
                <div class="flex justify-between gap-x-5 lg:gap-x-7.5">
                    <div class="text-xl lg:text-xxl">
                        Girişimciler, kendinizden başka kimseye hesap vermeyin
                    </div>
                    <figure>
                        <x-svgs.plane class="h-12 md:h-16" />
                    </figure>
                </div>
                <a href="{{ route('about') }}" title="Platformu Tanıyın" class="text-xxl md:text-2xl lg:text-2.25xl md:leading-snug flex items-center gap-x-3.5 hover:gap-x-5 md:gap-x-5 md:hover:gap-x-7 transition-all">Platformu
                    Tanıyın
                    <x-svgs.arrow class="w-12.5" />
                </a>
            </div>
            <div class="bg-bubble-gum space-y-9 lg:space-y-13 py-5 px-7.5 lg:py-7.5 lg:px-10 rounded-lg">
                <div class="flex justify-between gap-x-5 lg:gap-x-7.5">
                    ...
                    <figure>
                        <x-svgs.increasing-arrow class="h-12 md:h-16" />
                    </figure>
                </div>
                <a href="{{ route('fund') }}" title="Fırsatları Öğrenin" class="text-2xl md:text-2xl lg:text-2.25xl md:leading-snug flex items-center gap-x-3.5 hover:gap-x-5 md:gap-x-5 md:hover:gap-x-7 transition-all">Fırsatları
                    Öğrenin
                    <x-svgs.arrow class="w-12.5" />
                </a>
            </div>
    ...
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container class="grid gap-y-10 md:gap-y-15 lg:gap-y-0 lg:grid-cols-[auto_35.625rem] lg:gap-x-25">
            <figure class="justify-self-center">
                <img loading="lazy" src="img/illustration-1-img.svg" alt="Illustration" class="w-80 lg:w-full object-cover">
            </figure>
            <div class="space-y-5 md:space-y-7.5">
                <x-atoms.title-h2 title="Komünite girişimcilere neler sunuyor?" />
                ...
                <x-atoms.button href="{{ route('community') }}" title="Detaylı Bilgi" class="font-bold md:text-xl lg:text-1xl py-3 px-6 md:py-3.5 md:px-7" />
            </div>
        </x-atoms.container>
    </section>
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container class="grid gap-y-10 md:gap-y-15 lg:gap-y-0 lg:grid-cols-[35.625rem_auto] gap-x-32">
            <div class="space-y-5 md:space-y-7.5">
                <x-atoms.title-h2 title="Komünite yatırımcılara neler sunuyor?" />
                <ul class="list-disc text-lg md:text-xl lg:text-xxl space-y-2 ml-7">
                    <li>
                ...
                <x-atoms.button href="{{ route('funded') }}" title="Detaylı Bilgi" class="font-bold md:text-xl lg:text-1xl py-3 px-6 md:py-3.5 md:px-7" />
            </div>
            <figure class="justify-self-center">
                <img loading="lazy" src="img/illustration-2.svg" alt="Illustration" class="w-80 lg:w-full object-cover">
            </figure>
        </x-atoms.container>
    </section>
    <section class="bg-white py-10 md:py-15 lg:py-20 mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container class="space-y-10 md:space-y-15 lg:space-y-20">
            <div class="flex flex-col items-center text-center gap-y-5 md:gap-y-7.5">
                <x-atoms.title-h2 title="Melek yatırımlara bambaşka bir bakış: Katma Değer Fonu" class="sm:w-3/4" />
                <x-atoms.title-h4 title="Katma Değer Fonu, yaratıcı sektörlerde çalışan profesyoneller için bir mikro yatırım fonudur." class="sm:w-2/3" />
            </div>
            <x-molecules.checked-item title="Bir defa yap, hep sat!" desc="Türkiye’nin en yetenekli yaratıcılarının bir araya geldiği Komünite’ye katılın!" imgSrc="img/illustration-3-img.svg">
                <div class="space-y-4">
    ...
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container class="grid gap-y-7.5 lg:gap-y-0 lg:grid-cols-[auto_23.125rem] lg:gap-x-7.5">
            <div class="bg-navy text-bright space-y-5 md:space-y-7.5 py-9 px-7.5 md:py-11 md:px-10 rounded-lg">
                <div class="flex items-center gap-x-3.5 lg:gap-x-5">
                    <x-atoms.title-h3 title="Komünite" />
                    <x-svgs.heart class="w-8 lg:w-12" />
                    <x-atoms.title-h3 title="NFTler" />
                </div>
                <p class="text-lg md:text-1xl">Komünite Türk tasarımcıları, illüstratörleri ve sanatçıları dünya NFT çevrelerine açmak ve onların isimlerini büyütmek için bir NFT destek programı hazırlıyor.</p>
                <div title="Daha fazla bilgi" class="inline-block bg-ghost text-navy uppercase whitespace-nowrap rounded-lg font-bold text-xl md:text-1xl lg:text-2xl py-2 px-4 md:py-3 md:px-6 lg:py-4 lg:px-8">Çok yakında</div>
                <figure>
                    <img loading="lazy" src="img/coins.svg" alt="Coins" class="object-cover">
                </figure>
            </div>
            <div class="bg-turquoise space-y-3.5 md:space-y-5 p-7.5 md:p-10 rounded-lg">
                <x-svgs.the-bulten class="h-10" />
                <x-atoms.body-bold content="Kimsenin habere ihtiyacı yok, herkesin içgörüye ihtiyacı var." />
                <x-atoms.body-note content="O yüzden burada haber yok, burada içgörü var." />
                <x-atoms.body-note content="The Bülten ile girişimcilik, yaratıcı ekonomisi, yatırımlar ve uzaktan çalışma konularında bakış açısına sahip olun." />
                <div class="inline-block bg-almost-black text-bright uppercase whitespace-nowrap rounded-lg text-center font-bold md:text-xl lg:text-1xl py-2 px-4 md:py-3 md:px-6">
                    Çok yakında
                </div>
            </div>
        </x-atoms.container>
    ...
    <section class="mb-10 md:mb-15 lg:mb-20">
        <x-atoms.container>
            <x-atoms.title-h3 title="Komünite hakkında neler söylediler?" class="mb-7.5 lg:mb-10" />
            <div class="md:columns-2 lg:columns-3 md:gap-x-7.5 space-y-7.5">
